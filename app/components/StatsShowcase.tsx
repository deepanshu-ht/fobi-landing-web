      ...
      <div className="relative mx-auto max-w-6xl px-6 md:px-16">
        <div className="text-center space-y-3 md:space-y-4">
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3">
            <div className="inline-flex items-center rounded-full bg-gradient-to-r from-[#4DA3FF] to-[#3E5BFF] px-3 py-1 ring-1 ring-white/20">
              <div className="relative h-5 w-12 md:h-5 md:w-12">
                <Image src={badgeSrc} alt="badge" fill className="object-contain" />
              </div>
            </div>
            <h2 className="min-w-0 text-[24px] sm:text-[26px] md:text-[34px] leading-tight font-semibold tracking-[-0.01em] text-white">
              {title}
            </h2>
          </div>
        ...
        <div className="relative mt-10 md:mt-14 min-h-[520px] md:min-h-[560px]">
          <div className="relative z-10 flex justify-center gap-1 md:gap-4 pt-6 md:pt-8">
            ...
            <div className='flex flex-col gap-3 md:gap-4 w-[38%] md:w-81'>
              ...
              {leftItems[0] && (
                <div className='w-full md:w-81 rounded-xl bg-zinc-900/70 backdrop-blur-xl border border-white/10 p-5 md:p-6'>
